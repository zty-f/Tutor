<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="操作押金金额数量" prop="amount">
        <el-input
          v-model="queryParams.amount"
          placeholder="请输入操作押金金额数量"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="detailList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="用户押金操作信息表ID" align="center" prop="id" />
      <el-table-column label="操作押金金额数量" align="center" prop="amount" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="操作押金金额数量" prop="amount">
          <el-input v-model="form.amount" placeholder="请输入操作押金金额数量" />
        </el-form-item>
        <el-form-item label="押金余额" prop="balance">
...
<script>
import { listDetail, getDetail, delDetail, addDetail, updateDetail } from "@/api/core/deposit";

export default {
  name: "Detail",
  dicts: ['deposit_action_status'],
  data() {
    return {
      // 遮罩层
      loading: true,
      ...
      rules: {
        ...
        amount: [
          { required: true, message: "操作押金金额数量不能为空", trigger: "blur" }
        ],
        balance: [

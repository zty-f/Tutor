    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['core:testUser:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['core:testUser:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listTestUser, getTestUser, delTestUser, addTestUser, updateTestUser } from "@/api/core/testUser";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除测试用户信息编号为"' + userIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('core/testUser/export', {
        ...this.queryParams
